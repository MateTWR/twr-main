...
![spring bar tool](https://imagedelivery.net/X-EqW8t9MkEGniKrzeQMdA/2021-10-61wXMpc4riL._AC_UX679_.jpg/public)

### How to Change a Watch Strap Step By Step

1. Place the watch on your cushioned work area, dial side down, with the current strap opened.
2. Check to see if your watch's lugs have holes drilled all the way through them. If your watch has drilled lugs, insert the spring bar tool's pointed tip through each side. The ends of the spring bar will be depressed as a result of this.
3. While pushing with one hand, move the strap and release the spring bar from the lug with the other.
4. Remove the strap gently when both ends have released.Use the bent fork end of the spring bar tool if your watch doesn't have drilled lugs. Between the strap and the lug, slide the flat side of the fork against the watch case. You'll contact the spring bar's tiny ridge. Once it's engaged, pry the spring bar free with one hand using the fork's leverage. Then, using the other hand, gently press the strap forward to liberate the spring bar from its hole.
5. To make a spring bar strap, begin by inserting a set of spring bars into your new strap. On both sides, make sure each end stands out evenly.
6. With one end of the spring bar inserted into one of the lug holes, tighten the spring bar. Line align the other end of the spring bar with the hole on the opposite lug. Engage the tiny ridge on the spring bar with the fork end of your spring bar tool. Then press it on the strap until the spring bar's end slips into the lug. Gently raise and lower the strap until the spring bar clicks into position. Keep in mind the correct positioning of the two sides: in most cases, the buckled side of the strap will be at the twelve o'clock position.
7. Finally, tug on the new strap to ensure that it is properly secured. To make sure the replacement strap is in place, gently tug on both ends of the strap.
